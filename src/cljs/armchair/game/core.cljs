...
(defn add-animation-textures [animation-map]
  (transform [MAP-VALS MAP-VALS ALL FIRST]
             {:hare_down_idle1 ["hare.png" (m/Point. 6 0)]
              ...
              :guy_down_idle ["guy_sprite_sheet.png" (m/Point. 1 2)]
              :guy_down_walking1 ["guy_sprite_sheet.png" (m/Point. 0 2)]
              :guy_down_walking2 ["guy_sprite_sheet.png" (m/Point. 2 2)]
              :guy_left_idle ["guy_sprite_sheet.png" (m/Point. 1 3)]
              :guy_left_walking1 ["guy_sprite_sheet.png" (m/Point. 0 3)]
              :guy_left_walking2 ["guy_sprite_sheet.png" (m/Point. 2 3)]
              :guy_right_idle ["guy_sprite_sheet.png" (m/Point. 1 1)]
              :guy_right_walking1 ["guy_sprite_sheet.png" (m/Point. 0 1)]
              :guy_right_walking2 ["guy_sprite_sheet.png" (m/Point. 2 1)]
              :guy_up_idle ["guy_sprite_sheet.png" (m/Point. 1 0)]
              :guy_up_walking1 ["guy_sprite_sheet.png" (m/Point. 0 0)]
              :guy_up_walking2 ["guy_sprite_sheet.png" (m/Point. 2 0)]}
             animation-map))
