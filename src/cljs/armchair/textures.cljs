...
(def background-textures [:wall :stairs :red_wall-top-left :red_wall-top :red_wall_top-right :red_wall-left :red_wall-center :red_wall-right :red_wall-bottom-left :red_wall-bottom :red_wall-bottom-right :house_arch_top :house_bottom_left :house_bottom_right :house_door_bottom :house_roof_middle :house_roof_top :house_roof_bottom-left :house_roof_bottom-right :house_roof_bottom :house_roof_bottom2 :house_roof_middle-left :house_roof_middle-right :house_roof_top-left :house_roof_top-right :dirt :grass_dirt_bottom-left :grass_dirt_bottom :grass_dirt_bottom-right :grass_dirt_left :grass_dirt_right :grass_dirt_top-left :grass_dirt_top :grass_dirt_top-right :grass :grass_stone_bottom-left :grass_stone_bottom :grass_stone_bottom-right :grass_stone_left :grass_stone_right :grass_stone_top-left :grass_stone_top :grass_stone_top-right :stone_2 :stone_bush :stone_grass_bottom-left :stone_grass_bottom-right :stone_grass_top-left :stone_grass_top-right :stone :dngn_closed_door :dngn_unseen :dngn_open_door :gate_closed_left :gate_closed_middle :gate_closed_right :gate_open_left :gate_open_middle :gate_open_right])
