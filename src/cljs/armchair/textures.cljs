...
(def sprite-sheets
  (merge
    {:hare {:dimensions (Rect. 0 0 448 32)
            :tiles {[0 0] :hare_up_walking1
                    ...
                    [13 0] :hare_left_idle}}
     :guy_sprite_sheet {:dimensions (Rect. 0 0 96 128)
                        :tiles {[0 0] :guy_up_walking1
                                [1 0] :guy_up_idle
                                [2 0] :guy_up_walking2
     ...
     :adobe {:dimensions (Rect. 0 0 256 384)
             :tiles {[3 2] :house_arch_top
     ...
     :PathAndObjects_0 {:dimensions (Rect. 0 0 512 512)
                        :tiles {[9 2] :grass_dirt_bottom-left
                                ...
                                [14 9] :market-crate7
                                [15 9] :market-crate8}}
     :misc {:dimensions (Rect. 0 0 704 32)
            :tiles {[21 0] :wall
                    [20 0] :stairs
                    ...
                    [9 0] :gate_open_right}}
     :32x32_map_tile_v3.1 {:dimensions (Rect. 0 0 736 928)
                           :tiles {[5 21] :water1
                                   [3 21] :water2
                                   [10 1] :wood_panel1
                                   [10 2] :wood_panel2
                                   ...
                                   [0 13] :tree1-trunk1
                                   [1 13] :tree1-trunk2}}
     :mountain_landscape {:dimensions (Rect. 0 0 512 512)
                          :tiles {[7 13] :tree2_top-left
                                  [8 13] :tree2_top-right
                                  [7 14] :tree2_middle-left
                                  [8 14] :tree2_middle-right
                                  [7 15] :tree3_bottom-left
                                  [8 15] :tree3_bottom-right}}
     :Castle2 {:dimensions (Rect. 0 0 512 512)
               :tiles {[9 15] :crates-single
                       [10 14] :crates-tower1
                       [10 15] :crates-tower2}}
     :characters {:dimensions (Rect. 0 0 128 1664)
                  :tiles {[0 0] :acid_blob
                          [1 0] :agent
                          [2 0] :agnes
                          [3 0] :aizul
...
(def sprite-lookup
  (into {}
        (for [[file {sprites :tiles}] sprite-sheets
              [[tile-x tile-y] sprite] sprites]
          [sprite [file (Point. (* tile-size tile-x)
                                (* tile-size tile-y))]])))

(def texture-set (set (select [MAP-VALS :tiles MAP-VALS] sprite-sheets)))
...
(def background-textures
  (sort (select [(multi-path :adobe
                             ...
                             :Castle2
                             :mountain_landscape)
                 :tiles MAP-VALS] sprite-sheets)))

(def character-textures
  (sort (select [:characters :tiles MAP-VALS] sprite-sheets)))
