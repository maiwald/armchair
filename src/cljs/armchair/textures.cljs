...
(defrecord SpriteSheet [file-name bounds tile-size gutter offset])

(defn make-sprite-sheet
  ([file-name bounds]
   (SpriteSheet. file-name bounds config/tile-size 0 0))
  ([file-name bounds tile-size]
   (SpriteSheet. file-name bounds tile-size 0 0))
  ([file-name bounds tile-size gutter offset]
   (SpriteSheet. file-name bounds tile-size gutter offset)))
